...
exports.handler = async function (event) {
  ...
  try {
    // CRITICAL FIX: Handle empty or invalid JSON body safely
    if (event.body) {
  ...
  try {
    ...
    // Check if fields are missing AFTER parsing the body
    ...
    const payload = {
        ...
        // Explicit model declaration is required for robust API calls
